...
De esta manera, $P$ es el \textbf{polo trilineal respecto a $\triangle abc$}\index{trilineal!polo} de la recta $p$ y $p$ es la \textbf{polar trilineal respecto a $\triangle abc$}\index{trilineal!polar} del punto $P$.
