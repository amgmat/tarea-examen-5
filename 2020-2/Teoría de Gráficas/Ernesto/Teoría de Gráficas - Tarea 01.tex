...
% EXMEN \item Sean $G$ y $H$ gráficas tal que $G \cong H$. Demostrar que si $\varphi$ es el isomorfismo entre $G$ y $H$ entonces para cualquier $x \in V(G)$ se tiene que $d_G(x) = d_H(\varphi(x))$.
